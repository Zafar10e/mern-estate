...
export default function Listing() {
 ...
 return (
  <main>
   {loading && <p className='text-center text-2xl font-semibold my-7'>Loading...</p>}
    ...
    <div>
     ...
     <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
      ...
      <div className='flex gap-4'>
       <p className='bg-red-900 rounded-md w-full max-w-[200px] p-1 text-white text-center'>
        {listing.type === 'rent' ? 'For Rent' : 'For Sale'}
       </p>
       {
        listing.offer && (
         <p className='bg-green-900 w-full max-w-[200px] rounded-md text-white text-center p-1'>
      ...
      {currentUser && currentUser._id !== listing.urerRef && !contact && (
       <button
